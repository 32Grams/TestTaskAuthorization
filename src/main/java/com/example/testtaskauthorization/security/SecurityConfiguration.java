...
public class SecurityConfiguration {
    ...
    // Настройка приложения, что бы не авторизованным пользователям видна была только
    // страница на которой пользователь авторизуется.
    @Bean
